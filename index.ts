...
const webApp = new web.WebApp("webApp", {
    ...
    siteConfig: {
        ...
        // App settings are managed as a separate WebAppApplicationSettings resource
    },
}, {
...
const webAppApplicationSettings = new web.WebAppApplicationSettings("webAppApplicationSettings", {
    name: webApp.name,
    resourceGroupName: resourceGroup.name,
    properties: {
