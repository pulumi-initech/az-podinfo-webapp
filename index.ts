...
const webApp = new web.WebApp("webApp", {
    ...
    siteConfig: {
        ...
        loadBalancing: web.SiteLoadBalancing.LeastRequests,
        localMySqlEnabled: false,
        logsDirectorySizeLimit: 35,
        managedPipelineMode: web.ManagedPipelineMode.Integrated,
    ...
    ignoreChanges: ["customDomainVerificationId", "hostNameSslStates"], // Computed properties
});
