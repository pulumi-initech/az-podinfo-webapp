...
**Result**: ✅ 6 resources imported, 2 minor updates, 0 replacements/deletions
...
| `Microsoft.Insights/components` | `podinfo-webapp-28525-insights` | `azure-native.applicationinsights.Component` | `applicationInsights` | ⚠️ Minor Update |
| `Microsoft.Web/serverfarms` | `podinfo-webapp-28525-plan` | `azure-native.web.AppServicePlan` | `appServicePlan` | ✅ Perfect Import |
| `Microsoft.Web/sites` | `podinfo-webapp-28525` | `azure-native.web.WebApp` | `webApp` | ⚠️ Minor Update |
...
**Final Preview Status**: ✅ Near Zero-Diff Achieved
- **6 resources**: Perfect import (no changes)
- **2 resources**: Minor updates (non-breaking)
- **0 resources**: Replacements or deletions
...
# Should show: 6 imports, 2 minor updates, 0 replacements
```
